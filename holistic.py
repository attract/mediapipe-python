...
class Holistic(SolutionBase):
  ...
  def __init__(self,
    ...
    super().__init__(
        ...
        outputs=[
            'pose_landmarks', 'pose_world_landmarks', 'left_hand_landmarks', 'left_hand_world_landmarks',
            'right_hand_world_landmarks', 'right_hand_landmarks', 'face_landmarks', 'segmentation_mask'
        ])
